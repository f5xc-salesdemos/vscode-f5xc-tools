...
suite('Extension Test Suite', () => {
  ...
  suiteSetup(async () => {
    ...
    const ext = vscode.extensions.getExtension('f5xc-salesdemos.vscode-f5xc-tools');
    if (ext && !ext.isActive) {
      await ext.activate();
    }
  ...
  test('Extension should be present', () => {
    const extension = vscode.extensions.getExtension('f5xc-salesdemos.vscode-f5xc-tools');
